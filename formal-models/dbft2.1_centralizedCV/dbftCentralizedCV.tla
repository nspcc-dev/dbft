...
\* during waiting for PrepareResponse.
RMSendChangeView1(r) ==
  /\ rmState[r].type = "initialized"
  /\ \neg IsPrimary(r)
...
\* behaviour termination. We consider termination to be valid if all nodes
\* has the block being accepted.
Terminating ==
  /\ \A r \in RM : rmState[r].type = "blockAccepted"
  /\ UNCHANGED vars
...
\* Last modified Wed Mar 01 12:55:00 MSK 2023 by root
